...
🔗 **Live Demo:** [loan-approval-app.streamlit.app](https://loan-approval-app-ecnkr8pipfyrijb54vfzda.streamlit.app/)
...
1. Missing value imputation (mean for numeric columns, most frequent for categorical columns)
2. Label encoding for `Education_Level` and the target `Loan_Approved`
3. One-hot encoding for `Employment_Status`, `Marital_Status`, `Loan_Purpose`, `Property_Area`, `Gender`, `Employer_Category`
